...
// Avoid pulling in <stdio.h> from miniz, which conflicts with CRT
// declarations from ntdll.h (sprintf/sscanf/swprintf, etc.). We only
// need the core DEFLATE APIs, not ZIP/archive or stdio helpers.
