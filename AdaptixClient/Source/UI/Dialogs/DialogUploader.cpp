...
DialogUploader::DialogUploader(const QUrl &uploadUrl, const QString &headerKey, const QString &headerValue, const QString &fileName, const QByteArray &data, QWidget *parent) : QDialog(parent)
{
    setWindowTitle("Uploading...");
    resize(400, 150);
    this->setProperty("Main", "base");
    ...
    workerThread = new QThread(this);
    worker = new UploaderWorker(uploadUrl, headerKey, headerValue, fileName, data);
    worker->moveToThread(workerThread);
