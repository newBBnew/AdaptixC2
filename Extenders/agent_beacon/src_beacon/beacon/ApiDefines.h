...
// Compression-related ntdll APIs (LZNT1)
#define HASH_FUNC_RTLGETCOMPRESSIONWORKSPACESIZE     0x00000000
#define HASH_FUNC_RTLCOMPRESSBUFFER                  0x00000000
#define HASH_FUNC_RTLDECOMPRESSBUFFER                0x00000000
