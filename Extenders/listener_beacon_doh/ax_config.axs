...
function ListenerUI(mode_create)
{
    ...
    let labelDomain = form.create_label("Authoritative Domain:");
    let textDomain = form.create_textline("ns1.example.com");
    ...
    // SSL / HTTPS GroupBox (placed at bottom like HTTP listener)
    ...
    layout.addWidget(ssl_group,        8, 0, 1, 3);
